...
<p>
<ul>
<li>Cron: this will check every x amount of time (default 5 minutes) if the workflow rules are being followed. </li>
<li>Realtime: checks immediately if workflow rules are followed.</li>
</ul>
</p>
<p>
