...
import integria.integriaandroidconsole.Help;
...
public class IntegriaWebView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (url_integria.equals("http://firefly.artica.es/integria_demo/mobile")) {
			...
			myWebView.loadUrl(url_integria + "/index.php?action=login&password=" + password + "&user=" + user);
			Log.e("URL", url_integria + "/index.php?action=login&password=" + password + "&user=" + user);
