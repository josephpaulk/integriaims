<table align="center">
	<tr>
		<td>
			<div style="width:620px; color:black;">
			<?php echo  '<div><img src="'.$header_logo.'"></div>';?>
			</div>
			...
			<table style="border-top:2px solid black; width:620px; text-align:center;">
				<tr>
					<td style="text-align:left; font-size:16px; color:black;">
						...
						<?php if ($clean_output != 1) {
							echo '&nbsp;<img src="images/page_white_text.png" title="'.$invoice['description'].'">';
						} ?>
					</td>
				...
				<tr>
					<td style="padding-right:20px;">
						<div style="padding-left:4px; padding-right:4px;">
							...
							<?php echo '<div style="font-size:14px;padding-top:2px; padding-bottom:2px;"><pre>'.$config["invoice_header"].'</pre></div>' ?>
						</div>
					</td>
					<td style="padding-left:20px;">
						<div style="padding-left:4px; padding-right:4px;">
							<?php echo '<div align="center"><b style="font-size:16px; color:black;">'.__('Customer').'</b><br><br></div>' ?>
							<?php echo '<div style="font-size:14px; padding-top:2px; padding-bottom:2px;">'.$company_to['name'].'</div>' ?>
							<?php echo '<div style="font-size:14px; padding-top:2px; padding-bottom:2px;">'.$company_to['fiscal_id'].'</div>' ?>
							<?php echo '<div style="font-size:14px; padding-top:2px; padding-bottom:2px;">'.$company_to['address'].'</div>' ?>
							<?php echo '<div style="font-size:14px; padding-top:2px; padding-bottom:2px;">'.$company_to['country'].'</div>' ?>
						</div>
					</td>
				</tr>
			</table>
			<table style="border-top: 2px solid black; width:620px;">
				<tr>
				...
				if ($invoice['concept1'] != "") {
					echo '<tr>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:left;">'.$invoice['concept1'].'</td>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:right;">'
							.$invoice['amount1'].' '.$invoice['currency'].'</td>';
					echo '</tr>';
				}
				if ($invoice['concept2'] != "") {
					echo '<tr>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:left;">'.$invoice['concept2'].'</td>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:right;">'
				...
				if ($invoice['concept3'] != "") {
					echo '<tr>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:left;">'.$invoice['concept3'].'</td>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:right;">'
				...
				if ($invoice['concept4'] != "") {
					echo '<tr>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:left;">'.$invoice['concept4'].'</td>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:right;">'
				...
				if ($invoice['concept5'] != "") {
					echo '<tr>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:left;">'.$invoice['concept5'].'</td>';
						echo '<td style="padding:5px 15px 15px 15px; font-size:14px; text-align:right;">'
