...
echo "<table align=center width='90%'>";
	...
	echo "<tr>";
		echo "<td align='center' style='vertical-align:top'>";
			...
			echo "<td style='text-align:right;'>".calendar_seconds_to_humand($stats[INCIDENT_METRIC_TOTAL_TIME])."</td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td><strong>".__("Time no third people")."</strong>:</td>";
			echo "<td style='text-align:right;'>".calendar_seconds_to_humand($stats[INCIDENT_METRIC_TOTAL_TIME_NO_THIRD])."</td>";
			echo "</tr>";
			echo "</table>";
		echo "</td>";
		echo "<td align='center' style='vertical-align:top'>";
			...
			if ($workunit_count) {
				...
				echo "<td style='text-align:right;'>".calendar_seconds_to_humand($work_hours*3600)."</td>";
				echo "</tr>";
				echo "<tr>";
	...
	echo "<tr>";
		echo "<td align='center' style='vertical-align:top'>";
			...
			foreach ($stats[INCIDENT_METRIC_STATUS] as $key => $value) {
				...
				echo "<td style='text-align:right;'>".calendar_seconds_to_humand($value)."</td>";
				echo "</tr>";
			}
			echo "</table>";
		echo "</td>";
