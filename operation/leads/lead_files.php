...
$action = 'index.php?sec=customers&sec2=operation/leads/lead_detail&id=224&op=files&upload=1';				
...
$files = print_array_pagination ($files, "index.php?sec=customers&sec2=operation/leads/lead_detail&id=224&op=files");
...
if ($files !== false) {
	...
	foreach ($files as $file) {
		...
		if ( (dame_admin($config["id_user"])) || ($file["id_usuario"] == $config["id_user"]) ){
			$data[4] = "<a href='index.php?sec=customers&sec2=operation/leads/lead_detail&id=224&op=files&deletef=".$file["id_attachment"]."'><img src='images/cross.png'></a>";
		}
