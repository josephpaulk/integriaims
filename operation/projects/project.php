...
echo "<table width=710 class=box>";
	...
	echo "<td>";
	echo __('Project group');
	echo "<td>";
	echo print_select_from_sql ("SELECT * from tproject_group ORDER BY name", "filter_id_project_group", $filter_id_project_group, "", __('None'), '0', false, false, true, false);
