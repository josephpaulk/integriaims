...
echo "<h2>".__('Review of Integria audit logs')."</h2>";
...
echo '<tr>';
echo '<th class="w70">'.__('User').'</th>';
echo '<th>'.__('Action').'</th>';
echo '<th class="w130">'.__('Date').'</th>';
echo '<th class="w100">'.__('Source IP').'</th>';
echo '<th class="w200">'.__('Comments').'</th>';
